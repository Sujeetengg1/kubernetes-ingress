...
* Support for an OpenShift operator which manages the lifecycle of the Ingress Controller on OpenShift. See the [NGINX Ingress Operator GitHub repo](https://github.com/nginxinc/nginx-ingress-operator).
